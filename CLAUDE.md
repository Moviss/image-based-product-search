...
Upload a furniture image, get ranked matches from a ~2,500 product MongoDB catalog via Claude Vision analysis and re-ranking.
...
- Step 10 — pending (see `.ai/implementation-plan.md`)
